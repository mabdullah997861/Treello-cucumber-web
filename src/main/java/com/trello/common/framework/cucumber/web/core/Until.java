...
public class Until {
     ...
     *
     * @param numberOfCurrentWindowsOpened the number of current windows opened
     * @return boolean
     */
     ...
     *
     * @param elementLocator 				the Locator(LocatorType;LocatorValue) that specifies the object
     ...
     *
     * @param expectedPageTitle 				the fragment of title expected
